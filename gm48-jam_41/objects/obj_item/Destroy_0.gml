...
if (global.is_host == true && instance_exists(player_lock) && player_lock.object_index == obj_player)
{
...
else if (global.is_host == true)
{
	...
	if (instance_exists(player_lock) && player_lock.object_index == obj_player_dummy)
	{
