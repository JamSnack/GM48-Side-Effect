...
function get_item_data(item_id)
{
	...
	switch item_id
	{
		case ITEMID.item_coal: { data[0] = "Coal Ore"; data[1] = "Witty coal description here."; data[2] = "Increases Acceleration"; data[3] = "Decreases Weight Limit"; } break;
		...
		case ITEMID.item_iron: { data[0] = "Iron Ore"; data[1] = "Witty iron description here."; data[2] = "Increases Weight Limit"; data[3] = "Decreases Acceleration"; } break;
